...
var DerechoOpen = false;
var IzquierdoOpen = false;

$(document).ready(function(){
    
    $('#openTabDerecho').click(function (e) {
        if(!DerechoOpen)
        {
            $("#menuDerecho").addClass('active');
            $("#menuIzquierdo").removeClass('active');
            IzquierdoOpen = false;
        } else
            $("#menuDerecho").removeClass('active');
        e.preventDefault();
        DerechoOpen = !DerechoOpen;
    });
    
    $('#openTabIzquierdo').click(function (e) {
        if(!IzquierdoOpen)
        {
            $("#menuIzquierdo").addClass('active');
            $("#menuDerecho").removeClass('active');
            DerechoOpen = false;
        }
        else
            $("#menuIzquierdo").removeClass('active');
        IzquierdoOpen = !IzquierdoOpen;
        e.preventDefault();
    });
    ...
    $('.general_boton_favorito').click(function(){
        $.post('/favorito_post', {id:$(this).data('id')}, function(r){
            ...
            if (!r.error) {
                ...
                $('#favorito-message').hide();
                $('#favorito-message').addClass('active');
                $('#favorito-message').fadeIn();
            }
        });
    });
